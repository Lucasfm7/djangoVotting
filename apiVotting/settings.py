...
ALLOWED_HOSTS = ['django-server-production-f3c5.up.railway.app', '127.0.0.1', 'localhost','https://fasthtml-server-production-7db6.up.railway.app','https://fasthtml-server-production-7db6.up.railway.app/index_base.html']
